<header class="header">
		...
		<div class="container-xxl">
			<div class="row d-flex align-items-center">
				<div class="col-8 col-md-4">
					<a class="d-block py-2 py-md-4" href="#">
	...
	<!-- Navigation -->
	<?php include 'includes/navigation-two.php'; ?>
</header>